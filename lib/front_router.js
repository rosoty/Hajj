...
Router.route('/user/profile',{
	name:'profile',
	waitOn:function(){
		return [Meteor.subscribe("myprofile",Meteor.userId()),Meteor.subscribe("Allproduct"),Meteor.subscribe("allticketByUser",Meteor.userId()),Meteor.subscribe("GetPayment",Meteor.userId())]
	}
});
...
Router.route('/register/affiliate/:id',{
	...
	waitOn:function(){
		return [Meteor.subscribe("UserRegisterAffiliate"),Meteor.subscribe("GetPlatform")];
	}
});
Router.route('/ticket',{
	name:'ticket',
